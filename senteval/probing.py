...
class PROBINGEval(object):
    ...
    def run(self, params, batcher):
        ...
        if params.save_emb is not None:
            data_filename = 'npy/' + '_'.join(params.save_emb.split('_')[:-1]) + '_' + self.task + '.npy'
...
class Multi_SubjNumber(PROBINGEval):
    def __init__(self, task_path, seed=1111):
        task_path = os.path.join(task_path, 'SubjNumber.txt')
        PROBINGEval.__init__(self, 'SubjNumber', task_path, seed)

class Multi_ObjNumber(PROBINGEval):
    def __init__(self, task_path, seed=1111):
        task_path = os.path.join(task_path, 'ObjNumber.txt')
        PROBINGEval.__init__(self, 'ObjNumber', task_path, seed)
...
class Multi_SubjGender(PROBINGEval):
    def __init__(self, task_path, seed=1111):
        task_path = os.path.join(task_path, 'SubjGender.txt')
        PROBINGEval.__init__(self, 'SubjGender', task_path, seed)

class Multi_ObjGender(PROBINGEval):
    def __init__(self, task_path, seed=1111):
        task_path = os.path.join(task_path, 'ObjGender.txt')
        PROBINGEval.__init__(self, 'ObjGender', task_path, seed)

class Multi_SubjDefinite(PROBINGEval):
    def __init__(self, task_path, seed=1111):
        task_path = os.path.join(task_path, 'SubjDefinite.txt')
        PROBINGEval.__init__(self, 'SubjDefinite', task_path, seed)

class Multi_ObjDefinite(PROBINGEval):
    def __init__(self, task_path, seed=1111):
        task_path = os.path.join(task_path, 'ObjDefinite.txt')
        PROBINGEval.__init__(self, 'ObjDefinite', task_path, seed)
