...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="pixel", type=str, 
                        choices=["pixel", "mpixel", "vit-mae", "pixel-hindi"],
    ...
    model_dict = {"pixel": "Team-PIXEL/pixel-base", "mpixel": "Team-PIXEL/mpixel-base2", "vit-mae": "facebook/vit-mae-base", "pixel-hindi": "Team-PIXEL/pixel-base-finetuned-parsing-ud-hindi-hdtb"}
    access_token = args.auth

    # Set up logger
    logging.basicConfig(format='%(asctime)s : %(message)s', level=logging.DEBUG)
    renderer_cls = PangoCairoTextRenderer
    if "vit-mae" in args.model_name:
