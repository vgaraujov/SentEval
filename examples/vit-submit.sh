...
sbatch -o rando-eng-dep random-model.slurm dep UD_English-EWT
sbatch -o rando-eng-pos random-model.slurm pos UD_English-EWT
sbatch -o vit-eng-pos vit-finetuning.slurm pos UD_English-EWT
sbatch -o vit-eng-dep vit-finetuning.slurm dep UD_English-EWT
